...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { comments: @template.comments, name: @template.name } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { comments: @template.comments, name: @template.name } }
