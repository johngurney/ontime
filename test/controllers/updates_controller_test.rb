...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { comments: @update.comments, myuser_id: @update.myuser_id, task_id: @update.task_id } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { comments: @update.comments, myuser_id: @update.myuser_id, task_id: @update.task_id } }
